...
The entire project structure is generated by running populate_hpf_poc.py, which creates all folders, scripts and sample data files in one command.
...
Run the master setup script first to generate all folders,
scripts and sample data:

python populate_hpf_poc.py
...
- Excel and CSV read/write automation
- File system sorting with os and shutil
- Deadline monitoring with date filtering
